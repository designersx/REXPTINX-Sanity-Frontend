...
export default function Home() {
  ...
  const { header, footer, sections } = pageData;
      ...
      <main>
        {sections.map((section, index) => {
          switch (section._type) {
            ...
            case "heroSection1":
              return <HeroSection2 key={index} {...section} />;
            case "featuresSection":
              return <FeaturesSection key={index} {...section} />;
            case "BenefitSection":
              return <BenefitsSection key={index} data={section} />;
            case "testimonialsSection":
              return <TestimonialsSection key={index} {...section} />;
            case "pricingSection":
              return <PricingSection key={index} {...section} />;
            case "customIntegrationSection":
              return <CustomSection key={index} {...section} />;
            case "ctaSection":
